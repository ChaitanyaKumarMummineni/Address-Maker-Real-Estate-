...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            <p>property url<span> vr</span></p>
            <input type="text" name="url" maxlength="20801" placeholder="enter the webobook vr url" class="input">
         </div>
         <div class="box">
